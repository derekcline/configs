...
Plugin 'Shougo/neocomplete.vim' " neocomplete is better than AutoComplPop but requires vim compiled with lua
...
" Basic statusline (switched to vim-arline instead 2016-04)
...
" Set shift-k to perldoc -f while on that keyword
...
" NERDTree tabs: move left, move right, new tab
map <c-l> :tabn<cr>
map <c-h> :tabp<cr>
map <c-n> :tabnew<cr>
" }
